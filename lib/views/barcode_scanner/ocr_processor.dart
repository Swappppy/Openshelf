...
class OcrProcessor {
  /// Decodes, crops and saves an image. Returns true if successful.
  static Future<bool> processAndCrop(OcrCropParams params) async {
    try {
      final File originalFile = File(params.inputPath);
      if (!originalFile.existsSync()) return false;
