  ...
  Future<void> _save() async {
    ...
    try {
      ...
      await ref.read(bookFormControllerProvider).saveBook(
        ...
        collectionId: collections.firstOrNull?.$1,
        collectionName: _selectedCollections.firstOrNull?.$1.name,
        collectionNumber: collections.firstOrNull?.$2,
        publishYear: int.tryParse(_publishYearCtrl.text),
        translator: _translatorCtrl.text.trim().isEmpty ? null : _translatorCtrl.text.trim(),
        originalTitle: _originalTitleCtrl.text.trim().isEmpty ? null : _originalTitleCtrl.text.trim(),
        originalLanguage: _originalLanguageCtrl.text.trim().isEmpty ? null : _originalLanguageCtrl.text.trim(),
